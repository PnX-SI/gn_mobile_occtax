...
/**
 * Unit tests about [ObservationRecordDefaultJsonWriter].
 *
 * @author S. Grimault
 */
@RunWith(RobolectricTestRunner::class)
class ObservationRecordDefaultJsonWriterTest {
    ...
    fun `should write an empty observation record`() {
        ...
        val json = ObservationRecordDefaultJsonWriter().setIndent("  ")
    ...
    fun `should write an observation record with only start date defined`() {
        ...
        val json =
            ObservationRecordDefaultJsonWriter().write(observationRecord)
    ...
    fun `should write an observation record with module name defined`() {
        ...
        // when writing this observation record as JSON
        val json = ObservationRecordDefaultJsonWriter().write(observationRecord)
            .let { JSONObject(it).toMap() }
