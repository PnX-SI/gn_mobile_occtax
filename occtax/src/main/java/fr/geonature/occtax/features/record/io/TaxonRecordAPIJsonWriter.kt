...
/**
 * Default `JsonWriter` about writing an [TaxonRecord] as `JSON` for _GeoNature_ APIs.
 *
 * @author S. Grimault
 */
class TaxonRecordAPIJsonWriter {
     ...
     *
     * @return [TaxonRecordAPIJsonWriter] fluent interface
     */
    fun setIndent(indent: String): TaxonRecordAPIJsonWriter {
        this.indent = indent
     ...
     * @see [write][fr.geonature.occtax.features.record.io.TaxonRecordAPIJsonWriter.write(java.io.Writer, fr.geonature.occtax.features.record.domain.TaxonRecord)]
     */
